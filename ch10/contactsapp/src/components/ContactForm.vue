  ...
  <div class="modal">
    <div class="form" @keyup.esc="cancelEvent">
      ...
      <div class="form-group" v-if="mode=='update'">
        <label>일련번호</label>
        <input v-model="contact.no" type="text" name="no" class="long" disabled />
      </div>
      <div class="form-group">
        <label>이름</label>
        <input v-model="contact.name" type="text" name="name" class="long" ref="name" placeholder="이름을 입력하세요" />
      </div>
      <div class="form-group">
        <label>전화번호</label>
        <input v-model="contact.tel" type="text" name="tel" class="long" placeholder="전화번호를 입력하세요" />
      </div>
      <div class="form-group">
        <label>주소</label>
        <input v-model="contact.address" type="text" name="address" class="long" placeholder="주소를 입력하세요" />
      </div>
      <div class="form-group">
        <div>&nbsp;</div>
